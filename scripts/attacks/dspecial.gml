...
set_window_value(AT_DSPECIAL, 5, AG_WINDOW_VSPEED, 16);
...
set_hitbox_value(AT_DSPECIAL, 3, HG_WIDTH, 156);
...
set_hitbox_value(AT_DSPECIAL, 3, HG_VISUAL_EFFECT, soul_hit_heavy)
