...
set_window_value(AT_DSPECIAL, 5, AG_WINDOW_VSPEED, 15);
...
set_window_value(AT_DSPECIAL, 7, AG_WINDOW_ANIM_FRAMES, 0);
...
set_window_value(AT_DSPECIAL, 8, AG_WINDOW_ANIM_FRAME_START, 0);
...
set_hitbox_value(AT_DSPECIAL, 2, HG_HIT_SFX, asset_get("sfx_blow_strong1"));
