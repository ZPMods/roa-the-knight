...
set_window_value(AT_DSPECIAL, 1, AG_WINDOW_VSPEED, 55);
...
set_hitbox_value(AT_DSPECIAL, 5, HG_WINDOW_CREATION_FRAME, 12);
...
set_hitbox_value(AT_DSPECIAL, 6, HG_WINDOW_CREATION_FRAME, 15);
...
set_hitbox_value(AT_DSPECIAL, 7, HG_WIDTH, 150);
set_hitbox_value(AT_DSPECIAL, 7, HG_HEIGHT, 150);
...
set_hitbox_value(AT_DSPECIAL, 7, HG_KNOCKBACK_SCALING, 0.2);
set_hitbox_value(AT_DSPECIAL, 7, HG_BASE_HITPAUSE, 13);
set_hitbox_value(AT_DSPECIAL, 7, HG_HITPAUSE_SCALING, 0);
set_hitbox_value(AT_DSPECIAL, 7, HG_HIT_SFX, asset_get("sfx_blow_strong1"));
set_hitbox_value(AT_DSPECIAL, 7, HG_ANGLE_FLIPPER, 0);
set_hitbox_value(AT_DSPECIAL, 7, HG_DRIFT_MULTIPLIER, 0);
set_hitbox_value(AT_DSPECIAL, 7, HG_HITBOX_GROUP, 2);
