...
set_window_value(AT_FAIR, 1, AG_WINDOW_ANIM_FRAMES, STARTUP_FRAMES);
...
set_window_value(AT_FAIR, 2, AG_WINDOW_ANIM_FRAMES, ACTIVE_FRAMES);
set_window_value(AT_FAIR, 2, AG_WINDOW_ANIM_FRAME_START, ACTIVE_FRAME_START);

set_window_value(AT_FAIR, 3, AG_WINDOW_TYPE, 1);
set_window_value(AT_FAIR, 3, AG_WINDOW_LENGTH, 12);
set_window_value(AT_FAIR, 3, AG_WINDOW_ANIM_FRAMES, RECOVERY_FRAMES);
set_window_value(AT_FAIR, 3, AG_WINDOW_ANIM_FRAME_START, RECOVERY_FRAME_START);
