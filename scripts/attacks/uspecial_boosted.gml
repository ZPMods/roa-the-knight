...
set_hitbox_value(AT_USPECIAL_2, 2, HG_HITBOX_X, -15);
...
set_hitbox_value(AT_USPECIAL_2, 2, HG_SDI_MULTIPLIER, .8);
...
set_hitbox_value(AT_USPECIAL_2, 3, HG_SDI_MULTIPLIER, .8);
...
set_hitbox_value(AT_USPECIAL_2, 4, HG_KNOCKBACK_SCALING, 0.3);
...
set_hitbox_value(AT_USPECIAL_2, 4, HG_DRIFT_MULTIPLIER, 0);
