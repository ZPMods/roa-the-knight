...
set_hitbox_value(AT_USPECIAL_2, 1, HG_SDI_MULTIPLIER, .35);
...
set_hitbox_value(AT_USPECIAL_2, 2, HG_SDI_MULTIPLIER, .35);
...
set_hitbox_value(AT_USPECIAL_2, 3, HG_SDI_MULTIPLIER, .35);
