...
set_hitbox_value(AT_USPECIAL_2, 1, HG_WIDTH, 70);
...
set_hitbox_value(AT_USPECIAL_2, 1, HG_SDI_MULTIPLIER, .3);
...
set_hitbox_value(AT_USPECIAL_2, 2, HG_HITBOX_X, -21);
set_hitbox_value(AT_USPECIAL_2, 2, HG_HITBOX_Y, -40);
set_hitbox_value(AT_USPECIAL_2, 2, HG_WIDTH, 28);
...
set_hitbox_value(AT_USPECIAL_2, 2, HG_BASE_KNOCKBACK, 14);
...
set_hitbox_value(AT_USPECIAL_2, 2, HG_SDI_MULTIPLIER, .3);
...
set_hitbox_value(AT_USPECIAL_2, 3, HG_HITBOX_X, 21);
set_hitbox_value(AT_USPECIAL_2, 3, HG_HITBOX_Y, -40);
set_hitbox_value(AT_USPECIAL_2, 3, HG_WIDTH, 28);
...
set_hitbox_value(AT_USPECIAL_2, 3, HG_BASE_KNOCKBACK, 14); 
...
set_hitbox_value(AT_USPECIAL_2, 3, HG_SDI_MULTIPLIER, .3);
...
set_hitbox_value(AT_USPECIAL_2, 4, HG_WINDOW_CREATION_FRAME, 2);
set_hitbox_value(AT_USPECIAL_2, 4, HG_LIFETIME, 5);
set_hitbox_value(AT_USPECIAL_2, 4, HG_HITBOX_Y, -40);
set_hitbox_value(AT_USPECIAL_2, 4, HG_WIDTH, 86);
set_hitbox_value(AT_USPECIAL_2, 4, HG_HEIGHT, 86);
