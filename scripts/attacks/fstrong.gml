...
set_window_value(AT_FSTRONG, 3, AG_WINDOW_GOTO, 5);
...
set_window_value(AT_FSTRONG, 4, AG_WINDOW_GOTO, 4);
...
set_hitbox_value(AT_FSTRONG, 3, HG_HITBOX_X, 10);
...
set_hitbox_value(AT_FSTRONG, 4, HG_HITBOX_X, 35);
set_hitbox_value(AT_FSTRONG, 4, HG_HITBOX_Y, -10);
