...
set_attack_value(AT_FSPECIAL_2, AG_HURTBOX_SPRITE, sprite_get("uair_hurt"));
...
set_hitbox_value(AT_FSPECIAL_2, 4, HG_HITBOX_X, 18);
set_hitbox_value(AT_FSPECIAL_2, 4, HG_HITBOX_Y, -30);
