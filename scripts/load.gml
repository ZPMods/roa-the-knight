...
sprite_change_offset("uphurt", 82, 128);
sprite_change_offset("hurtground", 82, 128);
sprite_change_offset("crouch", 82, 128);
sprite_change_offset("walk", 82, 128);
sprite_change_offset("walkturn", 82, 128);
sprite_change_offset("dash", 82, 128);
sprite_change_offset("dashstart", 82, 128);
sprite_change_offset("dashstop", 82, 128);
sprite_change_offset("dashturn", 82, 128);

sprite_change_offset("jumpstart", 82, 128);
sprite_change_offset("jump", 82, 128);
sprite_change_offset("doublejump", 82, 128);
sprite_change_offset("walljump", 84, 128);
...
sprite_change_offset("tech", 82, 128);

sprite_change_offset("jab", 146, 192);
sprite_change_offset("dattack", 146, 192);
sprite_change_offset("ftilt", 146, 192);
...
sprite_change_offset("fspecial", 146, 192);
sprite_change_offset("fspecial_boosted", 146, 192);
...
sprite_change_offset("nspecial_boosted_proj_1",  52, 56);
sprite_change_offset("nspecial_boosted_proj_2",  52, 56);
sprite_change_offset("nspecial_boosted_proj_3",  52, 56);
sprite_change_offset("nspecial_boosted_proj_4",  52, 56);
sprite_change_offset("nspecial_boosted_proj_5",  52, 56);
sprite_change_offset("nspecial_boosted_proj_6",  52, 56);
sprite_change_offset("nspecial_boosted_proj_7",  52, 56);
sprite_change_offset("nspecial_boosted_proj_8",  52, 56);
sprite_change_offset("nspecial_boosted_proj_9",  52, 56);
sprite_change_offset("nspecial_boosted_proj_10", 52, 56);
