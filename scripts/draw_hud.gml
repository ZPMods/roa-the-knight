...
// draw_debug_text( temp_x+250, temp_y-70, string(shade_soul.timer_boom));
//draw_debug_text( temp_x+250, temp_y-90, string(shade_soul.shade_player_id.player));
// draw_debug_text( temp_x+250, temp_y-110, string(player));
