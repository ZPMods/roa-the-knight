...
{
  shader_start();
  draw_sprite_ext(sprite_get("rollforward_trail_1"), 0, rollforward_trail_1_x, rollforward_trail_1_y, 1, 1, 0, c_white, rollforward_trail_1_alpha);
  shader_end();
...
{
  shader_start();
  draw_sprite_ext(sprite_get("rollforward_trail_2"), 0, rollforward_trail_2_x, rollforward_trail_2_y, 1, 1, 0, c_white, rollforward_trail_2_alpha);
  shader_end();
...
{
  shader_start();
  draw_sprite_ext(sprite_get("rollforward_trail_3"), 0, rollforward_trail_3_x, rollforward_trail_3_y, 1, 1, 0, c_white, rollforward_trail_3_alpha);
  shader_end();
...
{
  shader_start();
  draw_sprite_ext(sprite_get("rollforward_trail_4"), 0, rollforward_trail_4_x, rollforward_trail_4_y, 1, 1, 0, c_white, rollforward_trail_4_alpha);
  shader_end();
...
{
  shader_start();
  draw_sprite_ext(sprite_get("rollbackward_trail_1"), 0, rollbackward_trail_1_x, rollbackward_trail_1_y, 1, 1, 0, c_white, rollbackward_trail_1_alpha);
  shader_end();
...
{
  shader_start();
  draw_sprite_ext(sprite_get("rollbackward_trail_2"), 0, rollbackward_trail_2_x, rollbackward_trail_2_y, 1, 1, 0, c_white, rollbackward_trail_2_alpha);
  shader_end();
...
{
  shader_start();
  draw_sprite_ext(sprite_get("rollbackward_trail_3"), 0, rollbackward_trail_3_x, rollbackward_trail_3_y, 1, 1, 0, c_white, rollbackward_trail_3_alpha);
  shader_end();
...
{
  shader_start();
  draw_sprite_ext(sprite_get("rollbackward_trail_4"), 0, rollbackward_trail_4_x, rollbackward_trail_4_y, 1, 1, 0, c_white, rollbackward_trail_4_alpha);
  shader_end();
